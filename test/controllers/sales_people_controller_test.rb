...
class SalesPeopleControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_person" do
    assert_difference('SalesPerson.count') do
      post sales_people_url, params: { sales_person: { first_name: @sales_person.first_name, last_name: @sales_person.last_name, sales_plan_id: @sales_person.sales_plan_id } }
    end
  ...
  test "should update sales_person" do
    patch sales_person_url(@sales_person), params: { sales_person: { first_name: @sales_person.first_name, last_name: @sales_person.last_name, sales_plan_id: @sales_person.sales_plan_id } }
