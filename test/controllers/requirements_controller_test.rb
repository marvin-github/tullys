...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { description: @requirement.description, detail: @requirement.detail, name: @requirement.name, start_date: @requirement.start_date, status: @requirement.status } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { description: @requirement.description, detail: @requirement.detail, name: @requirement.name, start_date: @requirement.start_date, status: @requirement.status } }
